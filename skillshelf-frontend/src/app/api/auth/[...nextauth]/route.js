  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        try {
          const response = await fetch('https://skillshelf-backend.vercel.app/api/auth/login', {
            method: 'POST',
    ...
    async signIn({ user, account, profile }) {
      ...
      if (account.provider === 'google') {
        try {
          ...
          const response = await fetch('https://skillshelf-backend.vercel.app/api/auth/google', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              email: user.email,
