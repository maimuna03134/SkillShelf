...
app.use(cors({
  origin: [
    'http://localhost:3000',
    'https://skill-shelf.vercel.app',
    'https://skill-shelf-s5kunsiml-styledecors-projects.vercel.app'
  ],
  credentials: true,
...
app.get('/', (req, res) => {
  res.json({ 
    message: 'SkillShelf Backend API is running!', 
    status: 'success',
...
app.post('/api/auth/login', async (req, res) => {
  try {
    ...
    console.log('User match:', user ? 'Found' : 'Not found');
